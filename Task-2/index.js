// Local data from the Fake Store API
const productsData = [
  {
    id: 1,
...
// Function to filter displayed products based on the search input
...
// Display all products when the DOM content is fully loaded
